...
Original file is located at
    https://colab.research.google.com/drive/1N222MJ3covMkamsLUrump6VI_Dj8PucC
"""
...
ax.set_xlabel('k')
ax.set_ylabel('cost')
ax.set_title('Sihoutte plot for choosing number of clusters K')
...
plt.title('Visualisation of Clusters in the Combined dataset')
